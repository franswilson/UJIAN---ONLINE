				...
				<div class="col-6">
				    <div id="navbar-menu">
    					<ul class="nav navbar-nav navbar-right">
    						<li class="dropdown">
    							<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background: white !important;">
    								<span style="display:block !important;">{{strtoupper(Auth()->user()->name)}}</span> <i class="icon-submenu lnr lnr-chevron-down" style="display:block !important;"></i></a>
